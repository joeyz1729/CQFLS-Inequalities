...
\begin{problem}{2010 中欧数学奥林匹克}{}
给定正整数 $n \ge 2$，求最大的实数 $\lambda$，使得对任意正实数 $a_1, a_2, \dots, a_n$，均有
\begin{equation}
    \frac{a_1^2 + a_2^2 + \dots + a_n^2}{n} \ge \left(\frac{a_1 + a_2 + \dots + a_n}{n}\right)^2 + \lambda(a_1 - a_n)^2
\end{equation}
\end{problem}
