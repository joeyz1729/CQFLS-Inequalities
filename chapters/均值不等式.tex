...
\begin{equation}
    1+\sum_{k=1}^{n}(k+1)x_k^k <\Bigl(1+\sqrt{\sum_{k=1}^{n}kx_k^{k+1}}\Bigr)^2
\end{equation}
\end{problem}
% 作业题 4
\begin{problem}{作业题 4}{}
...
\end{equation}
的最大值，其中 $a_{n+1}$ 应理解为 $a_1$ 或题目隐含循环条件（此处按题目原文保留 $a_n - a_1^2$）。
\end{problem}
...
\begin{thm}{四分之一引理}{}
设整数 $n\ge 4$，$a_{1},a_{2},\dots,a_{n}$ 是非负实数，则
\begin{equation}
...
\begin{equation}
    a_{1}a_{2}+a_{2}a_{3}+\dots+a_{n}a_{1}
\end{equation}
的最大值。
\end{problem}
