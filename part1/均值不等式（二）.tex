...
% 例 6
\begin{example}{}{}
设正实数 $a_{1},a_{2},\dots,a_{100}$ 满足 $a_{i}+a_{i+1}+a_{i+2}\le1,1\le i\le100$，其中下标按模 100 理解。求 $\sum_{i=1}^{100}a_{i}a_{i+1}$ 的最大值。
\end{example}
