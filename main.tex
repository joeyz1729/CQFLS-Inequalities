...
% \include{chapters/均值不等式}
% \include{chapters/柯西不等式}
\part{}
\include{chapters/恒等变形}
\include{chapters/abel变换}
\include{chapters/局部不等式}
\include{chapters/调整法}


% \include{chapters/伯努利不等式}
% \include{chapters/反向不等式}
% \include{chapters/绝对值不等式}
% \include{chapters/著名不等式}
% \include{chapters/平均值原理}


% \include{chapters/归纳法}



% \include{chapters/综合练习1}
