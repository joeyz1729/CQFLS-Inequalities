...
\begin{equation}
\Biggl[\sum_{i=1}^n\frac{x_i}{1+(n-2)x_i}\Biggr]^2
\leq\sum_{i=1}^n\frac{x_i^2}{[1+(n-2)x_i]^2}
+\frac{n}{4(n-1)}.
\end{equation}
\end{homework}
...
\newpage 
\begin{homework}{}
设整数 $n\geq 2$，实数 $a_1,a_2,\dots,a_n$ 满足 $\sum_{i=1}^n a_i^2=n$，证明
\begin{equation}
\sum_{1\leq i<j\leq n}\frac{1}{n-a_i a_j}
\leq\frac{n}{2}.
\end{equation}
\end{homework}
